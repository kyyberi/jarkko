---
title: AI Center of Excellence: What I Learned Building AI at Government Scale
date: 2026-09-13
category: AI strategy
summary: An AI Center of Excellence should turn scattered AI activity into repeatable product delivery, not become another central lab.
glance: An AI CoE is an operating model, not a queue of AI experts. | Portfolio decisions matter more than use-case volume. | Business owners must own outcomes while the center owns the common system. | The first 90 days should prove delivery evidence, not produce a large design exercise.
status: published
---
